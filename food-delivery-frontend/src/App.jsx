...
const getApiBaseUrl = () => {
  ...
  return `http://${hostname}:8082/api/users`
}
        ...
        <footer className="footer">
          <div className="info-chips">
            <div className="chip">
              ...
              <span className="chip-val">Port 4002 (React + Vite)</span>
            </div>
            <div className="chip">
              <span className="chip-label">Backend</span>
              <span className="chip-val">Port 8082 (Spring Boot 3)</span>
            </div>
            <div className="chip">
              <span className="chip-label">Database</span>
              <span className="chip-val">Port 5002 (PostgreSQL 16)</span>
            </div>
            <div className="chip">
