...
echo -e "${GREEN}======================================================${NC}"
echo -e "👉 ${CYAN}Frontend UI       :${NC} http://${SERVER_IP:-194.242.57.93}:4002"
echo -e "👉 ${CYAN}Backend REST API  :${NC} http://${SERVER_IP:-194.242.57.93}:8082/api/users"
echo -e "👉 ${CYAN}Actuator Metrics  :${NC} http://${SERVER_IP:-194.242.57.93}:8082/actuator/prometheus"
echo -e "👉 ${CYAN}PostgreSQL DB     :${NC} ${SERVER_IP:-194.242.57.93}:5003 (DB: fooddelivery02)"
echo -e "${GREEN}======================================================${NC}"
