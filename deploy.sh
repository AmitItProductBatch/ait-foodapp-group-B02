...
echo -e "${GREEN}======================================================${NC}"
echo -e "👉 ${CYAN}Frontend UI       :${NC} http://localhost:4002"
echo -e "👉 ${CYAN}Backend REST API  :${NC} http://localhost:8082/api/users"
echo -e "👉 ${CYAN}PostgreSQL DB     :${NC} localhost:5002 (DB: fooddelivery)"
echo -e "${GREEN}======================================================${NC}"
