...
public class RoleServiceImpl implements RoleService {
	...
	public List<RoleResponse> getAllRoles() {
		...
		for (Role role : roles) {
			...
			response.setRName(role.getRName());
